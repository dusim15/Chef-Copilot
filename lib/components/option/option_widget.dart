          ...
          child: Padding(
            ...
            child: StreamBuilder<List<GroceryItemRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                List<GroceryItemRecord> columnGroceryItemRecordList =
                    snapshot.data!;
                final columnGroceryItemRecord =
                    columnGroceryItemRecordList.isNotEmpty
                        ? columnGroceryItemRecordList.first
                        : null;
                return Column(
