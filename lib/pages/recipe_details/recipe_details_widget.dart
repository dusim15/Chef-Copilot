...
class RecipeDetailsWidget extends StatefulWidget {
  ...
  final DocumentReference? recipeDetails;
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: FutureBuilder<RecipeListRecord>(
          future: RecipeListRecord.getDocumentOnce(widget.recipeDetails!),
          builder: (context, snapshot) {
            ...
            final columnRecipeListRecord = snapshot.data!;
            return SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        ...
                        image: Image.network(
                          columnRecipeListRecord.imageUrl,
                        ).image,
                      ),
                                    ...
                                    Flexible(
                                      child: Padding(
                                        ...
                                        child: FFButtonWidget(
                                          ...
                                          text:
                                              columnRecipeListRecord.typeOfMeal,
                                          icon: Icon(
                              ...
                              children: [
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      8.0, 8.0, 24.0, 8.0),
                                  child: Text(
                                    columnRecipeListRecord.instructions,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Plus Jakarta Sans',
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(12.0, 24.0, 12.0, 44.0),
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
